    ...
    <div style={{ backgroundColor: '#000', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, padding: '150px 2rem 8rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        >
          ...
          <ParticleText text="PERSONAL BRANDING" fontSize={70} color="#ffffff" />
          <p style={{ color: '#A8A8A8', fontSize: '1.2rem', lineHeight: 1.6, marginTop: '2rem' }}>
            We craft compelling personal narratives for founders, creators, and emerging leaders. Transition from an unseen professional to a recognized industry voice.
          </p>
          ...
          <div style={{ marginTop: '3rem', textAlign: 'left', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '2.5rem' }}>
            ...
            <ul style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.2rem', listStyle: 'none', padding: 0 }}>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Founder Branding</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>LinkedIn Identity</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Public Positioning</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Authority Building</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Executive Presence</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Content Direction</li>
            </ul>
          </div>

          <div style={{ marginTop: '4rem', display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a 
              href="https://wa.me/917075853225?text=Hello%20NovelleyX%2C%20I%27m%20interested%20in%20Personal%20Branding"
              target="_blank" 
            ...
            <a 
              href="mailto:novelleyx@gmail.com?subject=Inquiry%20About%20Personal%20Branding&body=Hello%20Novelleyx%20team%2C%0A%0AI%20am%20interested%20in%20your%20Personal%20Branding%20services.%20Please%20let%20me%20know%20how%20we%20can%20proceed.%0A%0AThanks."
