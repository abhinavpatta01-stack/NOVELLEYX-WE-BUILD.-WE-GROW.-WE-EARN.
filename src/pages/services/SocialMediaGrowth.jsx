      ...
      <main style={{ flex: 1, backgroundColor: '#050505', position: 'relative', zIndex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: '150px 2rem 8rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          >
            ...
            <ParticleText text="SOCIAL MEDIA GROWTH" fontSize={70} color="#ffffff" />
            <p style={{ color: '#A8A8A8', fontSize: '1.2rem', lineHeight: 1.6, marginTop: '2rem' }}>
              We deploy curated growth engines to build premium audiences systematically. By decoding platform algorithms, we scale your influence and capture highly targeted demographics.
            </p>
            ...
            <div style={{ marginTop: '3rem', textAlign: 'left', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '2.5rem', backdropFilter: 'blur(10px)' }}>
              ...
              <ul style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.2rem', listStyle: 'none', padding: 0 }}>
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Instagram Growth</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>LinkedIn Authority</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Content Scaling</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Audience Positioning</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Engagement Systems</li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#D6D6D6', fontSize: '1rem' }}><div style={{ color: '#D4AF37' }}>✦</div>Algorithm Optimization</li>
              </ul>
            </div>

            <div style={{ marginTop: '4rem', display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <a 
                href="https://wa.me/917075853225?text=Hello%20NovelleyX%2C%20I%27m%20interested%20in%20Social%20Media%20Growth"
                target="_blank" 
              ...
              <a 
                href="mailto:novelleyx@gmail.com?subject=Inquiry%20About%20Social%20Media%20Growth&body=Hello%20Novelleyx%20team%2C%0A%0AI%20am%20interested%20in%20your%20Social%20Media%20Growth%20services.%20Please%20let%20me%20know%20how%20we%20can%20proceed.%0A%0AThanks."
