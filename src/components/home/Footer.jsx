...
const Footer = () => {
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      {/* Spacer to allow main content to scroll past the fixed footer */}
      <div style={{ height: '80vh', pointerEvents: 'none' }}></div>

      {/* Fixed Motion Footer (revealed as you scroll down) */}
      <footer 
        style={{
          position: 'fixed',
          bottom: 0,
          ...
          zIndex: -1, /* Keeps it behind the main scrolling content */
          display: 'flex',
      ...
      >
        ...
        <div style={{ maxWidth: '1440px', margin: '0 auto', width: '100%', position: 'relative', zIndex: 1, flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '4rem', marginBottom: 'auto' }}>
            {/* Brand & About */}
